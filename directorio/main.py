...
import cliente  # Importamos nuestro módulo de lógica de negocio
import producto
...
def menu_crear_producto(filepath: str):
    ...
    producto_creado = producto.crear_producto(
...
def menu_leer_productos(filepath: str):
    ...
    productos = producto.leer_todos_los_productos(filepath)
...
def menu_actualizar_producto(filepath: str):
    ...
    producto_actual = producto.buscar_producto_por_isdn(filepath, str(documento))
    ...
    producto_actualizado = producto.actualizar_producto(filepath, str(documento), datos_nuevos)
...
def menu_eliminar_producto(filepath: str):
    ...
    productos = producto.buscar_producto_por_isdn(filepath, str(documento))
    if not productos:
        console.print("\n[bold red]❌ No se encontró ningún producto con ese ISDN.[/bold red]")
        return
    ...
    if confirmacion:
        if producto.eliminar_producto(filepath, str(documento)):
